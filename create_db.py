...
with app.app_context():
    ...
    users = [
        ...
        # Add myself as a user in the database
        {'username': 'azimmer4', 'email': 'azimmer4@umd.edu', 'first_name': 'Alana', 'last_name': 'Zimmerman',
         'password': generate_password_hash('azimmer4pw', method='pbkdf2:sha256'), 'role': 'STUDENT'}
    ]
